...
if(params$pdf_mode){
  ...
  cat("[<i class='fas fa-download'></i> Download a PDF of this CV](https://github.com/Selkubi/CV/selin_kubilay_resume_pdf)")
}
```
...
The source code is available at [https://github.com/Selkubi/CV](https://github.com/Selkubi/CV).
