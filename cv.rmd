...
Aside
================================================================================
![](selin7.jpg){style="margin-top: -90px;" }

```{r}
if(params$pdf_mode){
  cat("View this CV online with links at [Selkubi](https://selkubi.github.io/cv.html)")
} else {
  cat("[<i class='fas fa-download'></i> See the html of this CV](https://selkubi.github.io/cv.html)")
}
```
...
The source code is available [on github.com/Selkubi/cv](https://github.com/Selkubi/CV/tree/main).
